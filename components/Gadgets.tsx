...
const Gadgets: React.FC = () => {
  return (
    <section id="gadgets" className="py-24 bg-slate-900/20 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 mb-8 max-w-2xl mx-auto">সিন্তিয়া টেলিকমে পাবেন সেরা মানের মোবাইল অ্যাকসেসরিজ ও ইলেকট্রনিক গ্যাজেট।</p>
          ...
          {gadgets.map((item) => (
            <div key={item.id} className="glass bg-slate-900 border border-white/10 rounded-[2rem] overflow-hidden group hover:border-sky-500/50 transition-all duration-300">
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 bg-sky-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                  {item.category}
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-bold text-lg text-white group-hover:text-sky-400 transition-colors">{item.name}</h3>
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <a 
                    ...
                    className="p-3 bg-white/5 hover:bg-sky-500 text-slate-300 hover:text-white rounded-xl transition-all"
                  >
